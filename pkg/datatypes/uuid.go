/*
Credits to gorm.io/datatypes
https://github.com/go-gorm/datatypes/blob/master/uuid.go
Edited to remove parts concerning MySQL in accordance with MIT License.
*/
